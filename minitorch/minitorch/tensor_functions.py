...
class Sigmoid(Function):
    ...
    def forward(ctx: Context, t1: Tensor) -> Tensor:
        # TODO: Implement for Task 2.3.
        # raise NotImplementedError("Need to implement for Task 2.3")
        # sig_fn = t1.f.sigmoid_map(t1)
        # ctx.save_for_backward (sig_fn)
        # return t1.f.sigmoid_map(sig_fn)
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        # TODO: Implement for Task 2.4.
        # raise NotImplementedError("Need to implement for Task 2.4")
        # sig_fn = ctx.saved_values
        # mul_1 = grad_output.f.mul_zip(sig_fn, (sig_fn-1))
        # mul_2 = grad_output.f.mul_zip(-1*sig_fn,mul_1)
        # return mul_2
...
class LT(Function):
    ...
    def forward(ctx: Context, a: Tensor, b: Tensor) -> Tensor:
        # TODO: Implement for Task 2.3.
        # raise NotImplementedError("Need to implement for Task 2.3")
        ctx.save_for_backward(zeros(a.shape), zeros(b.shape))
